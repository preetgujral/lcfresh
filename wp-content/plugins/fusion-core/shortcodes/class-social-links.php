...
class FusionSC_SocialLinks {
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s><div %s>%s</div></div></div>', FusionCore_Plugin::attributes( 'social-links-shortcode' ), FusionCore_Plugin::attributes( 'social-links-shortcode-social-networks' ), FusionCore_Plugin::attributes( 'fusion-social-networks-wrapper' ), $icons );
