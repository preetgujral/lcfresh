		...
		while ( $recent_works->have_posts() ) { 
			...
			if ( $layout == 'carousel' ) {
				...
				if ( ! has_post_thumbnail() &&
					...
					// Get the post image
					$image = avada_render_first_featured_image_markup( get_the_ID(), $this->image_size, get_permalink( get_the_ID() ), TRUE, FALSE, FALSE, 'disable', $show_title, '', $gallery_id );
				}
				...
				if ( ! has_post_thumbnail() &&
					...
					// Get the post image
					$image = avada_render_first_featured_image_markup( get_the_ID(), $this->image_size, get_permalink( get_the_ID() ), TRUE, FALSE, FALSE, 'disable', 'default', '', $gallery_id );
				}
