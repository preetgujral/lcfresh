...
See the", "Avada" ); ?> <?php printf( '<a href="%s">%1s</a> %2s', admin_url( 'admin.php?page=avada' ), __( "Product Registration", "Avada" ), __("tab for instructions on how to complete registration.", "Avada" ) ); ?></p>
	...
	<div class="avada-registration-steps">
    	<div class="feature-section col three-col">
        	<div class="col">
				<h3><span class="dashicons dashicons-sos"></span><?php echo __( "Submit A Ticket", "Avada" ); ?></h3>
            ...
            <div class="col">
				<h3><span class="dashicons dashicons-book"></span><?php echo __( "Documentation", "Avada" ); ?></h3>
        	...
        	<div class="col last-feature">
				<h3><span class="dashicons dashicons-portfolio"></span><?php echo __( "Knowledgebase", "Avada" ); ?></h3>
            ...
            <div class="col">
            	<h3><span class="dashicons dashicons-format-video"></span><?php echo __( "Video Tutorials", "Avada" ); ?></h3>
			...
			<div class="col">
				<h3><span class="dashicons dashicons-groups"></span><?php echo __( "Community Forum", "Avada" ); ?></h3>
            ...
            <div class="col last-feature">
				<h3><span class="dashicons dashicons-facebook"></span><?php echo __( "Facebook Group", "Avada" ); ?></h3>
				<p><?php echo __( "We have an amazing Facebook Group! Come and share with other Avada users and help grow our community. Please note, ThemeFusion does not provide support here.", "Avada" ); ?></p>
                <?php printf( '<a href="https://www.facebook.com/groups/AvadaUsers/" class="button button-large button-primary avada-large-button" target="_blank">%s</a>', __( "Facebook Group", "Avada" ) ); ?>
            </div>            
        </div>
    </div>
