...
class Fusion_Widget_Flickr extends WP_Widget {
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'screen_name' ); ?>"><?php printf( __( 'Flickr ID (%sGet your flickr ID%s):', 'Avada' ), '<a href="' . $flickr_getid_url . '">', '</a>' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'api' ); ?>"><?php printf( __( 'API key (Use default or get your own from %sFlickr APP Garden%s):', 'Avada' ), '<a href="' . $flickr_apply_url . '">', '</a>' ); ?></label>
