...
function avada_register_required_plugins() {
	...
	$plugins = array(
		array(
			...
			'external_url'       => '',
			'image_url'          => Avada()->get_framework_dir() . '/assets/images/fusion_core.png',
		),
		array(
			'name'               => 'LayerSlider WP',
			'slug'               => 'LayerSlider',
			...
			'force_deactivation' => false,
			'external_url'       => '',
			'image_url'          => Avada()->get_framework_dir() . '/assets/images/layer_slider.png',
		),
		array(
		...
		array(
			...
			'slug'      => 'woocommerce',
			'required'  => false,
			'image_url' => Avada()->get_framework_dir() . '/assets/images/woocommerce.png',
		),
		array(
			'name'      => 'bbPress',
			'slug'      => 'bbpress',
			'required'  => false,
			'image_url' => Avada()->get_framework_dir() . '/assets/images/bbpress.png',
		),
		array(
			'name'      => 'The Events Calendar',
			'slug'      => 'the-events-calendar',
			'required'  => false,
			'image_url' => Avada()->get_framework_dir() . '/assets/images/the_events_calendar.png',
		),
		array(
			'name'      => 'Contact Form 7',
			'slug'      => 'contact-form-7',
			'required'  => false,
			'image_url' => Avada()->get_framework_dir() . '/assets/images/contact_form_7.jpg',
		),
	);
