<div id="sidebar-2" <?php Avada()->layout->add_class( 'sidebar_2_class' ); ?> <?php Avada()->layout->add_style( 'sidebar_2_style' ); ?>>
	<?php
	if ( 'right' == Avada()->layout->sidebars['position'] ) {
	...
	if( isset( Avada()->layout->sidebars['sidebar_2'] ) && Avada()->layout->sidebars['sidebar_2'] ) {
		generated_dynamic_sidebar( Avada()->layout->sidebars['sidebar_2'] );
	}
	?>
</div>
